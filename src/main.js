...
const arraySeries = ["Sex Education", "Friends", "Suits", "The Flash", "Dark", "Breaking Bad", "Black Mirror: Bandersnatch", "Merlí", "The Rain", "Sense8"];

url = 'https://www.omdbapi.com/?t=';
let urlSeries = 'https://www.omdbapi.com/?s=';
...
let objTitlePelis = app.movieData;
